...
while True:
    ...
    while CollectdataFlag2:
        ...
        try:
            ...
            if temphum !=[]:
                #print(temphum)
                datatotrain.append([float(temphum[0]),float(temphum[1]),float(temphum1[0]),float(temphum1[1])])
                jj = jj+1
        ...
        for ccd in range (int(threshold/howmanytimes)):
            ...
            while CollectdataFlag2:
                ...
                try:
                    ...
                    if temphum !=[]:
                        #print(temphum)
                        datatotest.append([float(temphum[0]),float(temphum[1]),float(temphum1[0]),float(temphum1[1])])
                        jj = jj+1
                        #print(jj,float(temphum[0]),float(temphum[1]),float(temphum1[0]),float(temphum1[1]))
                        if jj>=threshold:
                            CollectdataFlag2 = 0
